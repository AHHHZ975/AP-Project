# Generated by Django 2.2 on 2019-06-02 06:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_audit', models.CharField(choices=[('حسابرسی شده', 'حسابرسی شده'), ('حسابرسی نشده', 'حسابرسی نشده')], default='', max_length=1)),
                ('type_date', models.CharField(choices=[('3', 'ماهه 3'), ('6', 'ماهه 6'), ('9', 'ماهه 9'), ('12', 'ماهه 12')], default='', max_length=2)),
                ('type_consolidated', models.CharField(choices=[('تلفیقی', 'تلفیقی'), ('غیرتلفیقی', 'غیرتلفیقی')], default='', max_length=2)),
