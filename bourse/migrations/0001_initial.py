# Generated by Django 2.2 on 2019-06-23 16:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('companyName', models.CharField(default='', max_length=32)),
                ('type_audit', models.CharField(choices=[('حسابرسی شده', 'حسابرسی شده'), ('حسابرسی نشده', 'حسابرسی نشده')], default='', max_length=16)),
                ('type_date', models.CharField(choices=[('3', 'ماهه 3'), ('6', 'ماهه 6'), ('9', 'ماهه 9'), ('12', 'ماهه 12')], default='', max_length=2)),
                ('type_consolidated', models.CharField(choices=[('تلفیقی', 'تلفیقی'), ('غیرتلفیقی', 'غیرتلفیقی')], default='', max_length=16)),
